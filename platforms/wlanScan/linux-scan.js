...
var exec = require("child_process").exec, networkUtils = require("./network-utils"), env = require("./env");

function scanWifi(i) {
    return function(u) {
        var o = [], v = {}, e = "nmcli -f all -m multiline dev wifi list";
        i.iface && (e += " iface " + i.iface), exec(e, env, function(e, i) {
            if (e) u && u(e); else {
                var r = !1, s = !1, n = !1, t = !1, a = !1;
