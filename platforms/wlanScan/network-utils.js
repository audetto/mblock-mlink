...
for (frequency = 5180, i = 36; i <= 64; i += 4) channels[i] = frequency.toString(), frequency += 20;
for (frequency = 5500, i = 100; i <= 144; i += 4) channels[i] = frequency.toString(), frequency += 20;
